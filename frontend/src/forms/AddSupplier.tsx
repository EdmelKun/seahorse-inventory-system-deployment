...
import { AddSupplierProps } from '../props/supplierProps';
  ...
  return (
    <div>
      <Dialog open={isOpen} onClose={closeHandler} maxWidth="md" fullWidth>
        <DialogTitle fontWeight="bold">ADD SUPPLIER</DialogTitle>
        <DialogContent>
      ...
      <SuccessNotification success={success} table="Supplier" action="Added" />
