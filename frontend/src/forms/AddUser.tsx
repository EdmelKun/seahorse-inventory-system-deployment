...
import { AddUserProps } from '../props/userProps';
import { addSuccessAlert, errorAlert } from '../functions/swalFunctions';
import userFormikSchema from '../formikSchema/userFormikSchema';
import { addUser } from '../functions/userActionFunctions';

export default function AddUser({ closeHandler, isOpen }: AddUserProps) {
  ...
  const { values, errors, touched, handleChange, handleSubmit } = useFormik({
    ...
    onSubmit: async () => {
      ...
      addUser(values.masterKey.trim(), action, data)
        .then(() => {
          addSuccessAlert();
        })
        .then(closeHandler)
